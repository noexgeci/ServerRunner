...
''')
        ...
        if os.path.exists(folder):
            sure = input(f'''{Back.WHITE}{Fore.BLACK}NOTE{Back.BLACK}{Fore.WHITE} This action will delete only the vanilla server files

Are you sure you want to reset all the files? (y/n): ''')
            if sure == ('y'):
                if os.path.isdir(f'{folder}/cache'): # dirs
